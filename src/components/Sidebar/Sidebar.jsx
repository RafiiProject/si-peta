...
const Sidebar = () => {
  ...
  const kecamatanPages = {
    ...
    dinas: { name: "Dinas", icon: <BusinessRoundedIcon /> },
  ...
  // Ambil segment pertama URL: misal "/tengah/view" => "tengah"
        ...
        <div className="sidebar-menu">
          {(isAdmin || isKecamatan) && (
            <Link
              ...
              className={currentPath === (isAdmin ? "/" : "/dashboarduser") ? "active" : ""}
            >
