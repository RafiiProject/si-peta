...
const AddData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/sipeta-ktp/backend/backtengah/process_add.php", {
        method: "POST",
        body: formDataToSend,
      });
          ...
          <div className="adddata-card">
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <div className="button-group mt-4 text-center">
                ...
                <button type="button" className="btn btn-red ms-2" onClick={() => navigate("/tengah")}>BATAL</button>
              </div>
            </form>
          </div>
        </div>
