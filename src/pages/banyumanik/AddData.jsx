...
const AddData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/sipeta-ktp/backend/backbanyumanik/process_add.php", {
        method: "POST",
        body: formDataToSend,
      });
      ...
      <div className="main-content">
        ...
        <div className="adddata-container">
          <div className="adddata-title-card">
            ...
            <h4 className="kecamatan-label">Kecamatan Banyumanik</h4>
          </div>
            ...
            <div className="form-row">
                <div>
                  ...
                  >
                    ...
                    {["PEMULA", "KEHILANGAN","CETAK ULANG(CU)", "ONLINE SKD", "ONLINE AKM", "ONLINE BIODATA", "PERUBAHAN DATA", "BANTUAN PINDAH", "GANTI FOTO", "GANTI TTD", "GANTI FOTO + TTD", "SKD + GANTI FOTO","LD", "RUSAK"].map((ket) => (
              ...
              <div className="form-row">
                <div>
                  ...
                  >
                    <option value="" disabled>PILIH KETERANGAN</option>
                    {["KEHILANGAN", "CETAK ULANG(CU)", "PEMULA", "RUSAK"].map((ket) => (
                      <option key={ket} value={ket}>{ket}</option>
                    ))}
                  </select>
                </div>
