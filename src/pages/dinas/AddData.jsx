...
const AddData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/sipeta-ktp/backend/backdinas/process_add.php", {
        method: "POST",
        body: formDataToSend,
      });
      ...
      <div className="main-content">
        ...
        <div className="adddata-container">
          <div className="adddata-title-card">
            ...
            <h4 className="kecamatan-label">Kecamatan Gayamsari/Kantor Dinas</h4>
          </div>
